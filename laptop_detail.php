...
$sql1="SELECT * from laptop_d where `p_Id`=$Id";
...
{
    $sql="SELECT `laptop_specification`.`generation` ,`laptop_specification`.`processor`,`laptop_specification`.`ram`,`laptop_specification`.`rom`, `laptop_specification`.`graphics memory` ,`laptop_specification`.`backlight`,`laptop_specification`.`screen size`,`laptop_specification`.`screen surface`, `laptop_specification`.`screen resolution`,`laptop_specification`.`touch screen`,`laptop_specification`.`camera`,`laptop_specification`.`price`,`laptop`.`Name`,`laptop`.`Image` from `laptop_specification` inner JOIN `laptop` on `laptop_specification`.`p_id`=`laptop`.`Id` where  `laptop_specification`.`p_id`=$Id;";
      ...
      while($row=mysqli_fetch_array($result))
    {
      ...
      $ram=$row['ram'];
      $rom=$row['rom'];
      $grap=$row['graphics memory'];
      $back=$row['backlight'];
      $size=$row['screen size'];
      $sur=$row['screen surface'];
      $res=$row['screen resolution'];
      $screen=$row['touch screen'];
      $cam=$row['camera'];
      $pri=$row['price'];
    }
                    ...
                    <div class=\"product_description\">
                        ...
                        <div class=\"row btnbuy\">
                            ...
                            <div class=\"col-lg-10\"> 
                             ...
                             <a href=\"addwish.php?ID=$Id&Name=$name&ty=laptop\"> <div class=\"product_fav\"><i class=\"fas fa-heart\"></i></div></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class=\"row\">
                <div class=\"col-md-12\">
                    <table class=\"col-md-12\">
                        <tbody>
                            <tr class=\"row mt-10\">
                                <td class=\"col-md-4\"><span class=\"p_specification\">Generation</span> </td>
                                <td class=\"col-md-8\">
                                    <ul>
                                        <li class=\"p_details\">$gen</li>
                                    </ul>
                                </td>
                            </tr>
                            <tr class=\"row mt-10\">
                            ...
                            <tr class=\"row mt-10\">
                                <td class=\"col-md-4\"><span class=\"p_specification\">Installed RAM</span> </td>
                                <td class=\"col-md-8\">
                                    <ul>
                                        <li class=\"p_details\">$ram</li>
                                    </ul>
                                </td>
                            </tr>
                            <tr class=\"row mt-10\">
                                <td class=\"col-md-4\"><span class=\"p_specification\">Hard Drive</span> </td>
                                <td class=\"col-md-8\">
                                    <ul>
                                        <li class=\"p_details\">$rom</li>
                                    </ul>
                                </td>
                            </tr>
                            <tr class=\"row mt-10\">
                                <td class=\"col-md-4\"><span class=\"p_specification\">Graphics Memory</span> </td>
                                <td class=\"col-md-8\">
                                    <ul>
                                        <li class=\"p_details\">$grap</li>
                                    </ul>
                                </td>
                            </tr>
                            <tr class=\"row mt-10\">
                                <td class=\"col-md-4\"><span class=\"p_specification\">Backlight</span> </td>
                                <td class=\"col-md-8\">
                                    <ul>
                                        <li class=\"p_details\">$back</li>
                                    </ul>
                                </td>
                            </tr>
                            <tr class=\"row mt-10\">
                                <td class=\"col-md-4\"><span class=\"p_specification\">Screen Size</span> </td>
                                <td class=\"col-md-8\">
                                    <ul>
                                        <li class=\"p_details\">$size</li>
                                    </ul>
                                </td>
                            </tr>
                            <tr class=\"row mt-10\">
                                <td class=\"col-md-4\"><span class=\"p_specification\">Screen Surface</span> </td>
                                <td class=\"col-md-8\">
                                    <ul>
                                        <li class=\"p_details\">$sur</li>
                                    </ul>
                                </td>
                            </tr>
                            <tr class=\"row mt-10\">
                                <td class=\"col-md-4\"><span class=\"p_specification\">Screeen Resolution</span> </td>
                                <td class=\"col-md-8\">
                                    <ul>
                                        <li class=\"p_details\">$res</li>
                                    </ul>
                                </td>
                            </tr>
                            <tr class=\"row mt-10\">
                                <td class=\"col-md-4\"><span class=\"p_specification\">Touch Screen</span> </td>
                                <td class=\"col-md-8\">
                                    <ul>
                                        <li class=\"p_details\">$screen</li>
                                    </ul>
                                </td>
                            </tr>
                            <tr class=\"row mt-10\">
...
";
echo $data;
$sql="SELECT count(`customer_name`) as num,sum(`value`) as rat,`value` from laptop_review where `p_id`=$Id";
    $result=mysqli_query($db,$sql);
    ...
    if(mysqli_num_rows($result) > 0)
     {
        ...
        $sql="SELECT `value` from laptop_review where `p_id`=$Id";
    $result=mysqli_query($db,$sql);
                ...
                <div class=\"col-lg-10 col-md-11 px-1 px-sm-2\">
                    <div class=\"card border-0 px-3\">
                        ...
                        <div class=\"d-flex row py-5 px-5 bg-light\">
                            ...
                            <div class=\"ml-md-auto p-2 mx-md-2 pt-4 pt-md-3\"> <a href=\"review_page.php?id=$Id\"><button class=\"btn btn-red px-4\">WRITE A REVIEW</button></a> </div>
                        </div> 
        ...
        <div class="row justify-content-center text-center">
          <div class="col-md-7">
            <div class="owl-carousel testimonial-carousel">
              <?php
               $sql="SELECT * from `laptop_review` where `p_id`=$Id;";
               $result=mysqli_query($db,$sql);
