...
<div class="container-fluid">
  ...
  <form action="" method="post">
    ...
    <input type="text" id="P1" name="ram" placeholder="RAM">
<br>
        <label for="fname">ROM</label><br>
    <input type="text" id="P2" name="rom" placeholder="ROM">
<br>
     <label for="fname">PROCESSOR</label><br>
    <input type="text" id="P3" name="pro" placeholder="PROCESSOR">
<br>
    <label for="fname">PRICE</label><br>
    <input type="text" id="P4" name="batt" placeholder="PRICE">
<br>
    <label for="fname">CAMERA</label><br>
    <input type="text" id="P5" name="cam" placeholder="CAMERA">
<br>
    <label for="fname">OPERATING SYSTEM OR GENERATION</label><br>
    <input type="text" id="P6" name="opera" placeholder="OPERATING SYSTEM OR GENERATION">
<br>
